define(function() {
    var Instructor = function(view, compiler, sections, options) {
        this.view     = view;
    ...
    (function() {
        ...
        this.$setUpLesson = function(lesson) {
            ...
            if (lesson.editorText) {
                ...
                this.compiler.compileIfCodeValid();
            }

            if (lesson.options && lesson.options.showPdf === false) {
                this.view.hidePdfPane();
                this.compiler.enableCompiling = false;
            } else {
                this.view.showPdfPane();
                this.compiler.enableCompiling = true;
            }
